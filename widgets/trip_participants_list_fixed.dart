...
class TripParticipantsListFixed extends StatefulWidget {
  ...
  @override
  State<TripParticipantsListFixed> createState() =>
      _TripParticipantsListFixedState();
}

class _TripParticipantsListFixedState extends State<TripParticipantsListFixed> {
        ...
        if (_participants.isNotEmpty) ...[
          ...
          Container(
            constraints: const BoxConstraints(
              maxHeight: 300,
            ), // Fixed max height instead of Expanded
